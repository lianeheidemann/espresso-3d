...
<p align="left">
  <img width="450" src="assets/interface-3.jpg" alt="Espresso3D interface: configuration panel on the left with engine, polygon count, texture, pose, license and export formats; 3D preview on the right">
</p>
